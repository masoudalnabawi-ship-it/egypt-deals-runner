...
CACHE_DIR = Path(os.getenv("V12_MULTISTORE_REVIEW_MEDIA_DIR") or (Path(__file__).resolve().parent.parent / ".runtime_state" / "v12_review_media_multistore"))
...
def capture(store: str, url: str, key: str, image_url: str = "") -> dict:
    ...
    try:
        ...
        return {
            "ok": False,
            "reason": str(exc)[:300],
            "source": "real_store_screenshot_required",
        }
